...
(function() {
  ...
  class Particle {
    ...
    run() {
      ...
      var dx = this.pX - this.pointer.x, dy = this.pY - this.pointer.y, r = 100 + this.size * 0.5, d = dx * dx + dy * dy;
      if (d < r * r) {
        d = Math.sqrt(d);
        dx /= d;
        dy /= d;
  ...
  this.N = 800;
  this.img = new Image();
  this.img.src = "./heart_codepen.png";
...
audioElement.addEventListener("timeupdate", function(e) {
  ...
  if (nowTime > 1 && lastTime < 5) {
    $("#peace h2")
      .siblings()
      .addClass("hidden")
      .removeClass("pushSoftOut");
    $("#heart")
      .addClass("hidden")
      .removeClass("pushSoftIn");
  }
